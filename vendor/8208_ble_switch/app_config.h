...
#define RC_BTN_ENABLE               				0

/* smart home setting -----------------------------------------------------------*/
#define SMART_HOME_CLIENT_SW_EN						1
#if SMART_HOME_CLIENT_SW_EN
#define SMART_HOME_SERVER_EN						1
#define TEST_SWITCH_KEY_FUNCTION_2_EN				0
#define BLE_REMOTE_PM_SIMPLE_EN						1	// use BLE_REMOTE_PM_ENABLE later.
//
#endif

#define C1T261A30_V1								1	// Development board
#define C1T261A5_V1									2	// Keyboard Panel

#define PCBA_8208_SEL								C1T261A30_V1

#ifndef GPIO_LED
#if (PCBA_8208_SEL == C1T261A30_V1)
#define GPIO_LED	GPIO_PA7
...
#elif (PCBA_8208_SEL == C1T261A5_V1)
#define DEBUG_TX_PIN           	GPIO_PA2
#endif
#define DEBUG_BAUDRATE         	(1000000) // (115200)
#define SIMU_UART_IRQ_EN    	(0)		// 1: disable irq while sending UART to keep baudrate stable.
#endif
...
#define 	SOFT_UART_RX_IO                   		GPIO_PD6
	...
	#define  KB_DRIVE_PINS  {GPIO_PD3, GPIO_PD6, GPIO_PA0}
	#define  KB_SCAN_PINS   {GPIO_PB0, GPIO_PB1, GPIO_PB4, GPIO_PB5, GPIO_PB6}
